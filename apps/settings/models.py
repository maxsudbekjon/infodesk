...
class Organization(TimeStampedModel):
    ...
    lead_consolidation = models.CharField(max_length=20, choices=LEAD_CONSOLIDATION.choices,
    ...
    sms_identifier = models.CharField(max_length=128, blank=True,
...
class ReceiptSettings(TimeStampedModel):
    ...
    branch = models.OneToOneField(Branch, related_name="receipt_settings", on_delete=models.CASCADE, null=True,
                                  blank=True)
    organization = models.ForeignKey(Organization, related_name="receipt_settings", on_delete=models.CASCADE, null=True,
                                     blank=True)
